...
<html lang="en">
    ...
    <body id="login-page">
        <div id="main-content" class="mylogin">
            <!-- 主体 -->
                    ...
                    <form action="<?php echo U('login');?>" method="post" class="login-form">
                        ...
                        <div id="itemBox" class="item-box">
                            <div class="item">
                                ...
                                <input class="my-input" type="text" name="username" placeholder="请填写用户名" autocomplete="off" />
                            </div>
                            <br/>
                            <br/>
                          ...
                          <!--  <span class="placeholder_copy placeholder_un">请填写用户名</span>-->
                            <div class="item b0">
                                ...
                                <input class="my-input" type="password" name="password" placeholder="请填写密码" autocomplete="off" />
                            </div>
                       ...
                       <!--     <div class="item verifycode">
                        ...
                        <div class="login_btn_panel">
                            <button class="login-btn btn btn-default" type="submit">
