...
<body>
    ...
    <div id="auth_groups">
        <form class="form-horizontal" action="<?php echo U('addToGroup');?>" method="post" enctype="application/x-www-form-urlencoded" target-form="form-horizontal">
                <?php if($existence == 1): ?>该用户本属于的角色：<span style="color:red;"><?php echo ($name); ?></span><?php endif; ?>
			<label class="item-label"><?php echo ($names); ?> 所属的角色列表</label>
