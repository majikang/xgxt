...
<body>
    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            <label class="item-label">图标<span class="check-tips">（bootstrap中Glyphicons字体图标）</span></label>
            <div class="controls">
                <span class="<?php echo ((isset($info["icon"]) && ($info["icon"] !== ""))?($info["icon"]):''); ?>"></span>
                <input type="text" class="text input-large" name="icon" value="<?php echo ((isset($info["icon"]) && ($info["icon"] !== ""))?($info["icon"]):''); ?>">
            </div>
        </div>
        <div class="form-item">
